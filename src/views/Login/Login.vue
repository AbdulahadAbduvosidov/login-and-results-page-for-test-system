<template>
    <div class="base flex justify-center items-center min-h-screen bg-cover bg-center">
        <div class="w-[400px] md:w-[500px] p-10 bg-white rounded-xl bg-opacity-60">
            <img class="w-24 sm:w-[120px] mx-auto" src="../../assets/img/tatu.png" alt="">
            ...
            <form>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password" v-model="password"
                        class="w-full p-2 sm:p-[10px] border rounded-[9px]" placeholder="••••••••" required />
                </div>
                <div class="flex items-center mb-4 justify-between">
                    <div>
                        <input class="mr-2 mb-1 h-3 w-3 sm:h-[15px] sm:w-[15px] rounded-md" type="checkbox" />
